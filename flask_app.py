...
from app_flask.views import UserView
from app_flask.product_view import ProductView
from app_flask.categoria_view import CategoriaView
from app_flask.database import init_app #importo desde la conección a la base de datos
